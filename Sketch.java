...
public class Sketch extends PApplet {
  ...
  public void settings() {
    //Sets size of screen to screen width and screen height
    ...
    for(int i = 0; i < ROW_COUNT; i++){
      for (int h = 0; h < COLUMN_COUNT; h++){
        ...
        if(i > 0 && i < 9){
          ...
          if(intGrid[h][i] == 1 && intGrid[h][i+1] == 1){
            rowCont+=1;
          }
            
          if(intGrid[h][i] == 1 && intGrid[h][i-1] == 1 && i==9){
            rowCont+=1;
          }
          
          if(intGrid[h][i] == 1 && intGrid[h][i-1] == 1 && intGrid[h][i+1] == 1 && i < 9){
            rowCont+=1;
      ...
      for (int f = 0; f < COLUMN_COUNT; f++){
       ...
       System.out.println("There are " + colCellCount + " cells selected on Column " + f);
        colCellCount = 0;
